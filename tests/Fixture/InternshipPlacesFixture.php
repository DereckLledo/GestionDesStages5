...
/**
 * InternshipPlacesFixture
 *
 */
class InternshipPlacesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'administrative_region' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'actif' => ['type' => 'boolean', 'length' => null, 'null' => true, 'default' => '1', 'comment' => '', 'precision' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'internship_places_ibfk_1' => ['type' => 'foreign', 'columns' => ['id'], 'references' => ['officials', 'id_internship_place'], 'update' => 'cascade', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
