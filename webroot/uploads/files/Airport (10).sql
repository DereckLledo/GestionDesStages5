...
--
-- Client :  localhost
-- Généré le :  Lun 12 Novembre 2018 à 20:57
...
--
CREATE DATABASE IF NOT EXISTS `Airport` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `Airport`;
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Les avions';
...
(2, 3, 3, 1, 'Airbus A380', 100, 300000, 'Nouvelle avion', 'airbus-a380', '2018-09-01 00:54:45', '2018-10-11 17:55:41'),
(3, 1, 2, 1, 'Nimbus 2000', 666, 666000, 'Tu est un sorcier Harry', 'nimbus-2000', '2018-09-10 00:00:00', '2018-10-11 17:55:57');
...
CREATE TABLE IF NOT EXISTS `airlines` (
  ...
  `created` datetime NOT NULL,
  `modified` datetime NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Les compagnies aériennes';
...
(1, 1, 2, 'e56498bae1.png', 'uploads/files/', '2018-10-10 16:31:24', '2018-10-10 16:31:24', 1),
(2, 4, 1, 'JapanAirlines.png', 'uploads/files/', '2018-10-11 19:09:58', '2018-10-11 19:09:58', 1),
(3, 4, 3, '2000px-American_Airlines_logo_2013.svg.png', 'uploads/files/', '2018-10-11 19:18:45', '2018-10-11 19:18:45', 1);
...
CREATE TABLE IF NOT EXISTS `flight_schedules` (
  ...
  `created` datetime NOT NULL,
  `modified` datetime NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Les horaires de vol';
...
(1, 1, 1, 1, 'V384', 'Departure', '2018-08-31 04:05:00', '2018-05-05 06:08:00', 'None', 'v384', '2018-09-01 01:16:38', '2018-10-10 16:26:23'),
(2, 2, 1, 2, 'V157', 'Arrival', '2019-02-15 12:00:00', '2019-02-15 15:13:00', 'Pilot switch', 'v157', '2018-09-01 01:18:15', '2018-09-12 02:15:01'),
(3, 1, 3, 1, 'V294', 'Arrival', '2018-09-10 19:13:00', '2018-09-10 19:13:00', 'None', 'v294', '2018-09-10 19:14:07', '2018-10-10 16:39:15'),
(4, 2, 3, 2, 'V420', 'Departure', '2018-10-09 23:42:00', '2018-10-09 23:42:00', 'None', 'v420', '2018-10-09 23:43:01', '2018-10-10 16:39:49');
...
CREATE TABLE IF NOT EXISTS `hangars` (
  ...
  `span_id` int(11) DEFAULT NULL,
  `hangar_size` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `other_detail` varchar(255) COLLATE utf8_unicode_ci DEFAULT 'None',
  `slug` varchar(191) COLLATE utf8_unicode_ci NOT NULL,
  `created` datetime NOT NULL,
  `modified` datetime NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Les hangars';

--
-- Contenu de la table `hangars`
--

INSERT INTO `hangars` (`id`, `user_id`, `code`, `size_id`, `span_id`, `hangar_size`, `other_detail`, `slug`, `created`, `modified`) VALUES
(1, 2, 'A527G', 1, 2, '120', 'None', 'A527G', '2018-08-31 23:20:12', '2018-10-10 16:34:10'),
(2, 1, 'H5UI2', 2, 5, '100', 'Need repair', 'H5UI2', '2018-09-01 00:41:49', '2018-10-10 16:32:59'),
(3, 2, 'IF987D', 3, 9, '100', 'None', 'IF987D', '2018-09-12 00:58:18', '2018-10-10 16:34:38'),
(4, 1, 'GG666', 4, 13, '90', 'None', 'GG666', '2018-09-12 01:01:15', '2018-10-10 16:34:04');
...
(4, 'fr_CA', 'Aircrafts', 3, 'other_detail', 'Tu est un sorcier Harry'),
(5, 'fr_CA', 'Aircrafts', 1, 'other_detail', 'Rouge'),
(6, 'en_US', 'Aircrafts', 2, 'other_detail', 'New aircraft'),
(7, 'en_US', 'Aircrafts', 3, 'other_detail', 'You are a wizard Harry'),
(8, 'ja_JP', 'Aircrafts', 1, 'other_detail', 'ブルー'),
(9, 'ja_JP', 'Aircrafts', 2, 'other_detail', '新しい飛行機'),
(10, 'ja_JP', 'Aircrafts', 3, 'other_detail', 'あなたはウィザードのハリーです'),
...
(20181108170639, 'Initial', '2018-11-08 22:06:39', '2018-11-08 22:06:39', 0),
(20181108192553, 'Initial', '2018-11-09 00:25:53', '2018-11-09 00:25:53', 0);
...
CREATE TABLE IF NOT EXISTS `pilots` (
  ...
  `created` datetime NOT NULL,
  `modified` datetime NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Les pilotes';
...
(2, 2, '1234567', 'Julie', 'Pommier', 'F', 'None', 'julie-pommier', '2018-09-01 01:15:30', '2018-10-10 16:40:56');
...
--
-- Contenu de la table `spans`
--

INSERT INTO `spans` (`id`, `category_id`, `name`) VALUES
(1, 1, '1-9m'),
(2, 1, '10-19m'),
(3, 1, '20-29m'),
(4, 2, '30-39m'),
...
ALTER TABLE `sizes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT pour la table `spans`
--
ALTER TABLE `spans`
...
--
ALTER TABLE `hangars`
  ADD CONSTRAINT `size_id` FOREIGN KEY (`size_id`) REFERENCES `categories` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `span_id` FOREIGN KEY (`span_id`) REFERENCES `subcategories` (`id`) ON UPDATE CASCADE,
...
--
-- Contraintes pour la table `spans`
--
ALTER TABLE `spans`
  ADD CONSTRAINT `id_category` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON UPDATE CASCADE;
