...
--
-- Client :  localhost
-- Généré le :  Mer 14 Novembre 2018 à 18:42
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Les avions';
...
(1, 1, 2, 2, 'Boeing 730', 100, 85000, 'Bleu', 'boeing-730', '2018-08-31 07:41:37', '2018-11-14 17:32:22'),
(2, 3, 3, 1, 'Airbus A420', 100, 300000, 'Nouvelle avion', 'airbus-a420', '2018-09-01 00:54:45', '2018-11-14 17:32:45'),
(3, 1, 2, 1, 'Nimbus 2018', 666, 666000, 'Tu est un sorcier Harry', 'nimbus-2018', '2018-09-10 00:00:00', '2018-11-14 17:32:37');
...
CREATE TABLE IF NOT EXISTS `hangars` (
  ...
  `created` datetime NOT NULL,
  `modified` datetime NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Les hangars';

--
-- Contenu de la table `hangars`
--

INSERT INTO `hangars` (`id`, `user_id`, `code`, `span_id`, `other_detail`, `slug`, `created`, `modified`) VALUES
(1, 2, 'A527G', 2, 'None', 'A527G', '2018-08-31 23:20:12', '2018-10-10 16:34:10'),
(2, 1, 'H5UI2', 5, 'Need repair', 'H5UI2', '2018-09-01 00:41:49', '2018-10-10 16:32:59'),
(3, 2, 'IF987D', 9, 'None', 'IF987D', '2018-09-12 00:58:18', '2018-10-10 16:34:38'),
(4, 1, 'GG666', 13, 'None', 'GG666', '2018-09-12 01:01:15', '2018-10-10 16:34:04'),
(10, 4, 'test', 1, 'None', 'test', '2018-11-14 00:25:53', '2018-11-14 00:26:00');
...
INSERT INTO `spans` (`id`, `size_id`, `name`) VALUES
(1, 1, '1-9m'),
(2, 1, '10-19m'),
(3, 1, '20-29m'),
(4, 2, '30-39m'),
...
--
ALTER TABLE `hangars`
  ADD CONSTRAINT `span_id` FOREIGN KEY (`span_id`) REFERENCES `spans` (`id`) ON UPDATE CASCADE,
...
--
ALTER TABLE `spans`
  ADD CONSTRAINT `id_category` FOREIGN KEY (`size_id`) REFERENCES `categories` (`id`) ON UPDATE CASCADE;
